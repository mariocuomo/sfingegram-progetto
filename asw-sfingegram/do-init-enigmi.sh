...
curl -X POST "http://localhost:8080/enigmi/enigmi" -H "accept: */*" -H "Content-Type: application/json" -d "{ \"autore\": \"massimo\", \"tipo\": \"marino\", \"titolo\": \"Il Corriere della Sera\", \"testo\": [ \"È un noto quotidian di gran formato.\" ], \"soluzione\": [ \"Il pane\" ] }"
echo 
